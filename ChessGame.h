...
public:
  ...
  void getStartPosition(BasicBoard& bb);
  void setStartPosition(const BasicBoard& bb);
  void setStartPosition(const char* fen);
  bool toStart();
  bool toEnd(bool variation=false);
  bool goTo(const BasicBoard& bb, bool strict=true);
